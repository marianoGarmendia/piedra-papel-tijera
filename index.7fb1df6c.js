var e=globalThis,t={},n={},a=e.parcelRequire5feb;null==a&&((a=function(e){if(e in t)return t[e].exports;if(e in n){var a=n[e];delete n[e];var r={id:e,exports:{}};return t[e]=r,a.call(r.exports,r,r.exports),r.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,t){n[e]=t},e.parcelRequire5feb=a),(0,a.register)("27Lyk",function(e,t){Object.defineProperty(e.exports,"register",{get:()=>n,set:e=>n=e,enumerable:!0,configurable:!0});var n,a=new Map;n=function(e,t){for(var n=0;n<t.length-1;n+=2)a.set(t[n],{baseUrl:e,path:t[n+1]})}}),a("27Lyk").register(new URL("",import.meta.url).toString(),JSON.parse('["dZpbI","index.7fb1df6c.js","3n06e","star-red.e9298925.png","l8b8L","star-green.741bfdeb.png","iMGB9","papel-grande.7657fda8.png","fkAYp","piedra-grande.235b1aee.png","6bNvX","tijera-grande.fa900d32.png","5mdmA","papel.97b4e337.png","hbeyn","piedra.f7ab90c7.png","cnU0O","tijera.af887105.png"]'));class r extends HTMLElement{constructor(){super(),this.computerPoints=this.getAttribute("computerPoints"),this.myPoints=this.getAttribute("myPoints")}connectedCallback(){this.render()}render(){let e=this.attachShadow({mode:"open"}),t=document.createElement("div"),n=document.createElement("div"),a=document.createElement("div"),r=document.createElement("div");n.appendChild(a),n.appendChild(r),n.classList.add("containerTotalPoints");let s=document.createElement("div"),i=document.createElement("div"),o=document.createElement("style");t.classList.add("container"),o.textContent=`
    ...
    `,this.classList.add("tanteador"),a.textContent="0",r.textContent="0",s.textContent=this.computerPoints||0,i.textContent=this.myPoints||0,// containerPoints.appendChild(containerTotalPoints);
t.appendChild(s),t.appendChild(i),e.appendChild(t),e.appendChild(o)}}customElements.define("tanteador-el",r);class s extends HTMLElement{constructor(){super(),this.texto=this.getAttribute("texto")||""}connectedCallback(){this.render()}render(){let e=this.attachShadow({mode:"open"}),t=document.createElement("button"),n=document.createElement("style");t.textContent=`${this.texto}`,n.textContent=`
    button{
        border-radius: 10px;
    ...
    `,e.appendChild(t),e.appendChild(n)}}customElements.define("button-el",s);var i={};i=new URL("star-red.e9298925.png",import.meta.url).toString();var o={};o=new URL("star-green.741bfdeb.png",import.meta.url).toString();class l extends HTMLElement{constructor(){super(),this.texto=this.getAttribute("texto"),this.color=this.getAttribute("color"),this.render()}render(){let e=this.attachShadow({mode:"open"}),t=document.createElement("div");t.classList.add("container");let n=document.createElement("p"),a=document.createElement("img"),r=document.createElement("img"),s=document.createElement("style");return a.src=new URL(i),r.src=new URL(o),n.textContent=this.texto||"",s.textContent=`
        .container{
            position: relative;
            display: flex;
    ...
    `,"red"==this.color?t.appendChild(a):"green"==this.color&&t.appendChild(r),t.appendChild(n),e.appendChild(s),e.appendChild(t),e}}customElements.define("resultado-el",l);class c extends HTMLElement{constructor(){super(),this.title=this.getAttribute("title"),this.puntajePlayerUno=this.getAttribute("scoreUno"),this.puntajePlayerDos=this.getAttribute("scoreDos")}connectedCallback(){this.render()}render(){let e=this.attachShadow({mode:"open"}),t=document.createElement("div"),n=document.createElement("style");n.textContent=`
        .container{
            border-radius: 10px;
...
n[1].style.transform="translate(-125px,70px)",n[1].style.transition="transform 0.5s",n[1].style.opacity="0.5",n[2].style.transform="translate(0,70px)",n[2].style.opacity="0.5"):"piedra"==e?(n[1].style.transform="translate(0,-170px)",n[1].style.transition="transform 0.5s",n[0].style.transform="translate(0,70px)",n[0].style.transition="transform 0.5s",n[0].style.opacity="0.5",n[2].style.transform="translate(0,70px)",n[2].style.opacity="0.5",n[2].style.transition="transform 0.5s"):"tijera"==e&&(n[2].style.transform="translate(-125px,-170px)",n[2].style.transition="transform 0.5s",n[0].style.transform="translate(0,70px)",n[0].style.transition="transform 0.5s",n[0].style.opacity="0.5",n[1].style.transform="translate(125px,70px)",n[1].style.opacity="0.5",n[1].style.transition="transform 0.5s"),setTimeout(()=>{n.forEach(e=>{e.style.transform="",e.style.transition="",e.style.opacity=""})},3e3)}const b=document.querySelector(".root"),S="/piedra-papel-tijera/",E=[{path:/\/inicio$/,handle:function(e){let t=document.createElement("div");t.innerHTML=`
    ...
    `;let n=t.querySelector(".btn-empezar");return n?.addEventListener("click",()=>{e("jugar")}),t}},{path:/\/jugar$/,handle:function(e){let t=document.createElement("div");t.innerHTML=`
      ...
      `;let n=t.querySelector(".btn-jugar");return n?.addEventListener("click",()=>{e("game")}),t}},{path:/\/game$/,handle:function(){let e=document.createElement("div"),t=function(n,a,r){let s,i;e.innerHTML=`
    <div class="game-page">
    ...
    `;let o=e.querySelector(".hands-container");return setTimeout(()=>{let e=document.querySelector(".hands-container")?.children[0].children,n=Array.prototype.slice.call(e);if(i=g.computerPlay(),setTimeout(()=>{o.style.pointerEvents="auto"},3e3),o?.getAttribute("select")){console.log("fui sleccionado");let e=g.getState();x(i),g.setMove(s.id,i),setTimeout(()=>{if(""==e.currentGame.ganador)return n.forEach(e=>{e.style.transform="",e.style.transition="",e.style.opacity=""}),o.style.pointerEvents="auto",t(e.currentGame.myPlay,e.currentGame.computerPlay,e.currentGame.playTime);e.historyGame.push({...e.currentGame}),g.setState(e),G("endgame")},3e3)}else{console.log("no fui seleccionado"),o.style.pointerEvents="none",s="piedra",x(i);{let e=document.querySelector(".hands-container")?.children[0].children,t=Array.prototype.slice.call(e);g.setMove(s,i),console.log(s+i),f(s,t)}let e=g.getState();setTimeout(()=>{if(""==e.currentGame.ganador)return n.forEach(e=>{e.style.transform="",e.style.transition="",e.style.opacity=""}),o.style.pointerEvents="auto",t(e.currentGame.myPlay,e.currentGame.computerPlay,e.currentGame.playTime);e.historyGame.push({...e.currentGame}),g.setState(e),G("endgame")},3e3)}},3e3),o?.addEventListener("click",e=>{o.setAttribute("select","true"),o.style.pointerEvents="none",s=e.target;{let e=document.querySelector(".hands-container")?.children[0].children,t=Array.prototype.slice.call(e);f(s.id,t)}}),e};return g.suscrcribe(()=>{let e=g.getState(),t=e.currentGame.myPlay,n=e.currentGame.computerPlay,a=e.currentGame.playTime;""==e.currentGame.ganador&&(a>=3?t>n?g.whoWins("yo"):t<n&&g.whoWins("computer"):2==a&&(2==t?g.whoWins("yo"):2==n&&g.whoWins("computer")))}),t(0,0,0)}},{path:/\/endgame$/,handle:function(e){let t=0,n=0,a=g.getState();return a.historyGame.map(e=>{"yo"==e.ganador?n+=1:"computer"==e.ganador&&(t+=1)}),function(t,n,a){let r=document.createElement("div");"yo"==t.ganador?r.classList.add("container-end-game-winner"):r.classList.add("container-end-game-looser"),r.innerHTML=`
          <div class="end-page">
      ...
      <div class="container-buttons">
        ...
        <button-el texto="Inicio" class="btn-inicio"></button-el>
          ...
          `;let s=r.querySelector(".btn-empezar");s?.addEventListener("click",()=>{let t=g.getState();// currentState.historyGame.push({ ...currentState.currentGame });
t.currentGame.myPlay=0,t.currentGame.computerPlay=0,t.currentGame.playTime=0,t.currentGame.ganador="",g.setState(t),e("game")});let i=r.querySelector(".btn-inicio");return i?.addEventListener("click",()=>{let t=g.getState();// currentState.historyGame.push({ ...currentState.currentGame });
t.currentGame.myPlay=0,t.currentGame.computerPlay=0,t.currentGame.playTime=0,t.currentGame.ganador="",t.historyGame=[],g.setState(t),e("inicio")}),r}(a.currentGame,n,t)}}];function v(e){if(C()){let t=e.replace(S,"/");for(let e of E)if(e.path.test(t)){let t=e.handle(G);L(t)}}else for(let t of E)if(t.path.test(e)){let e=t.handle(G);L(e)}}function L(e){b?.firstChild?(b.firstChild.remove(),b.appendChild(e)):b?.appendChild(e)}function G(e){if(C()){let t=S+e;history.pushState({},"",t),v(t)}else"/inicio"==e?(history.pushState({},"",e),v(e)):(history.pushState({},"","/"+e),v("/"+e))}function H(){location.pathname==S?G("inicio"):"/"==location.pathname?G("/inicio"):v(location.pathname)}function C(){return location.host.includes("github.io")}window.addEventListener("popstate",()=>{H()}),g.initState(),H(),function(){class e extends HTMLElement{constructor(){super(),this.size=this.getAttribute("size")}connectedCallback(){this.render()}render(){let e=document.createElement("div"),t=document.createElement("style"),n=document.createElement("img"),a=document.createElement("img"),r=document.createElement("img");if(n.id="papel",a.id="piedra",r.id="tijera",e.classList.add("container"),t.textContent=`
            .container{
                display: flex;
            ...
            //  }
        `,"grande"==this.size){let e=new URL(d);n.src=e;let t=new URL(p);a.src=t;let s=new URL(m);r.src=s}else{let e=new URL(u);n.src=e;let t=new URL(y);a.src=t;let s=new URL(h);r.src=s}e.appendChild(n),e.appendChild(a),e.appendChild(r),this.appendChild(e),this.appendChild(t)}}customElements.define("hands-container",e),new e}(),function(){class e extends HTMLElement{constructor(){super();// this.render();
...
}();//# sourceMappingURL=index.7fb1df6c.js.map
